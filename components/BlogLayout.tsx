...
const BlogLayout = ({ title, date, coverPhoto, content }: BlogLayoutProps) => {
  return (
    <>
      <Container className="my-16 lg:my-32">
        {coverPhoto && (
          <Image
            ...
            alt={coverPhoto.image.alternateText || "alt text"}
            className="h-full w-full object-cover object-center sm:rounded-3xl"
            width={coverPhoto.image.width}
            height={coverPhoto.image.height}
          />
        )}
